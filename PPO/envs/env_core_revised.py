...
elif flag_env == 1:   # resnet JUDGE / transformer judge
    from envs.collect_data_2 import get_reward
    pra_txt = "C:\\data\\pra_all_2.txt"
    reward_txt = "C:\\data\\reward_2.txt"
elif flag_env == 3:   # FCN JUDGE / transformer judge
    from envs.collect_data_3 import get_reward
    pra_txt = "C:\\data\\pra_all_3.txt"
    reward_txt = "C:\\data\\reward_3.txt"
elif flag_env == 4:  # online learning
    from envs.collect_data_4 import get_reward
    pra_txt = "C:\\data\\pra_all_4.txt"
    reward_txt = "C:\\data\\reward_4.txt"
...
elif flag_env == 6:  # multi_EP trans judge
    from envs.multi_collect_data_2 import get_reward
    pra_txt = "C:\\data\\pra_all_6.txt"
    reward_txt = "C:\\data\\reward_6.txt"
elif flag_env == 7:  # multi_EP trans judge
    from envs.multi_collect_data_3 import get_reward
    pra_txt = "C:\\data\\pra_all_7.txt"
    reward_txt = "C:\\data\\reward_7.txt"
elif flag_env == 8:  # whole sequence trans
    from envs.multi_collect_data_4 import get_reward
    pra_txt = "C:\\data\\pra_all_8.txt"
    reward_txt = "C:\\data\\reward_8.txt"
...
class EnvCore(object):
    ...
    def __init__(self, tunable_indices=None, fixed_values=None):
        ...
        # self.search_threshold = 200   # BR
        self.search_threshold = 400     # MCTS

        # [112,48,52,152,48,48,112,92,80,76]
        # self.agent_num = 4
        self.agent_num = 1

        self.tunable_indices =  [0, 1, 6, 7]  
    ...
    def _get_reward(self, pras_int):
        ...
        if self.search_triggered and self.reward_call_count % self.search_threshold == 0:
            ...
            self.run_parameter_search()  # BEST-RESPONSE
            # self.run_mcts_search()         # MCTS-SEARCH
            time.sleep(10)
        return reward
    ...
    def run_mcts_search(self):
        ...
        from envs.MCTS_response import run_mcts_with_update
        new_params1, new_reward1, global_pra1, global_reward1 = run_mcts_with_update(initial, iterations=60)

        # 更新环境状态
        self.last_obs =new_params1
        if self.best_reward < global_reward1:

            self.best_reward = global_reward1
            self.best_pra = global_pra1.copy()
